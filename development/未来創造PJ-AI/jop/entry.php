...
if (isset($_POST['entry'])) {
    ...
    if (empty($uname) || empty($email) || empty($password)) {
        ...
        $query = "INSERT INTO job_users (uname, email, password) VALUES ($1, $2, $3)";
...
<head>
    ...
    <style>
        ...
        .circle-2 {
            background-color: rgb(227, 246, 246); /* 円2の色 */
    ...
    <div class="form-container">
        ...
        <?php endif; ?>
            ...
            <div class="users">
                ...
                <button class="entry" type="submit" name="entry" href="entry_data1.php">登録</button>
            </div>
